...
# Due Diligence Assistant — Codex CLI wrapper

This is the **Codex CLI wrapper** for `due-diligence-assistant`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
