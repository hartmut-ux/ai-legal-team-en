...
# Due Diligence Assistant — Claude Code wrapper

This is the **Claude Code wrapper** for `due-diligence-assistant`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `due-diligence-assistant`
- "run due-diligence-assistant"
