...
# Litigation Support — Codex CLI wrapper

This is the **Codex CLI wrapper** for `litigation-support`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
