...
# Contract Analyst — Claude Code wrapper

This is the **Claude Code wrapper** for `contract-analyst`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `contract-analyst`
- "run contract-analyst"
